...
project = u'rllab'
copyright = u'2016, rllab contributors'
author = u'rllab contributors'
...
latex_documents = [
  (master_doc, 'rllab.tex', u'rllab Documentation',
   u'rllab contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'rllab', u'rllab Documentation',
     [author], 1)
]
